                        ...
                        <div class="body">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line {{ $errors->has('location') ? 'focused error' : '' }}">
                                    ...
                                    <select name="location" id="location" class="form-control show-tick" data-live-search="true" >
                                        @foreach($areas as $area)
                                            <option value="{{ $area->id }}" @if($area->id == $post->location) selected @endif>{{ $area->area_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <a  class="btn btn-danger m-t-15 waves-effect" href="{{ route('user.post.index') }}">BACK</a>
