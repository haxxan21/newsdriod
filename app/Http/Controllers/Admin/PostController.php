...
class PostController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.post.create',compact('categories','tags', 'areas'));
    }
...
//            make unipue name for image
    ...
    public function edit(Post $post)
    {
        ...
        $tags = Tag::all();
        $areas = DB::table('areas')->orderBy('area_name')->get();
        return view('admin.post.edit',compact('post','categories','tags', 'areas'));
    }
...
//            delete old post image
    ...
    public function approval($id)
    {
        ...
        if ($post->is_approved == false)
        {
            $post->is_approved = true;
            $post->save();
            $post->user->notify(new UserPostApproved($post));
